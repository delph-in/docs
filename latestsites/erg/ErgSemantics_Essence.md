...
[ErgSemantics](https://delph-in.github.io/docs/erg/ErgSemantics)) captures *sentence meaning* in an abstract
...
see [ErgSemantics Basics](https://delph-in.github.io/docs/erg/ErgSemantics_Basics).
...
[compounding](https://delph-in.github.io/docs/erg/ErgSemantics_Compounding) or
[conditionals](https://delph-in.github.io/docs/erg/ErgSemantics_Conditionals).
...
modification](https://delph-in.github.io/docs/erg/ErgSemantics_Design#non-scopal-modification), [control
constructions](https://delph-in.github.io/docs/erg/ErgSemantics_ControlRelations), [coordinate
structures](https://delph-in.github.io/docs/erg/ErgSemantics_Coordination), as illustrated in Example (1),
...
[below](https://delph-in.github.io/docs/erg/ErgSemantics_Essence#senses)). The representation is
...
[ErgSemantics/Basics](https://delph-in.github.io/docs/erg/ErgSemantics_Basics)) must be bound by a
...
[Coordination](https://delph-in.github.io/docs/erg/ErgSemantics_Coordination),
[Nominalization](https://delph-in.github.io/docs/erg/ErgSemantics_Nominalization), or
[Partitives](https://delph-in.github.io/docs/erg/ErgSemantics_Partitives)). Where there is an overt
...
[Implicit Quantifiers](https://delph-in.github.io/docs/erg/ErgSemantics_ImplicitQuantifiers) for further
details.
...
can be found in the [SEM-I](https://delph-in.github.io/docs/erg/ErgSemantics_Interface) (semantic
...
[ErgSemantics Basics](https://delph-in.github.io/docs/erg/ErgSemantics_Basics#Convenience)). Here, we
...
described [above](https://delph-in.github.io/docs/erg/ErgSemantics_Essence#ArgumentIdentification)). Since
