...
for](https://delph-in.github.io/docs/erg/ErgProcessing) Linux; (b) [the stand-alone ACE or PET
parsers](https://delph-in.github.io/docs/erg/ErgProcessing), which can be compiled in various
operating environments; and (c) a ‘thin’, portable client against the
[RESTful on-line interface](https://delph-in.github.io/docs/erg/ErgProcessing). Each of these
...
pages [LogonTop](https://delph-in.github.io/docs/tools/LogonTop) and [LogonInstallation](https://delph-in.github.io/docs/tools/LogonInstallation)
...
[LogonInstallation](https://delph-in.github.io/docs/tools/LogonInstallation) page. However, to merely parse a
...
[LogonProcessing/BatchParsing](https://delph-in.github.io/docs/tools/LogonProcessing_BatchParsing) page.
...
[ErgProcessing/SampleExport](https://delph-in.github.io/docs/erg/ErgProcessing_SampleExport) page; formats
(a), (c), and (d) are further discussed to some degree on the
[ItsdbDerivations](https://delph-in.github.io/docs/tools/ItsdbDerivations), [ErgSemantics](https://delph-in.github.io/docs/erg/ErgSemantics), and
[EdsTop](https://delph-in.github.io/docs/tools/EdsTop) pages, respectively).
...
[ErgTop](https://delph-in.github.io/docs/erg/ErgTop) and [LogonTop](https://delph-in.github.io/docs/tools/LogonTop) pages on this wiki, maybe
...
[ErgApi](https://delph-in.github.io/docs/erg/ErgApi) page.
